...
-- Step 3: Create triggers (run after tables and indexes)
...
-- Step 4: Enable RLS (run after all tables are created)
...
-- Step 5: Create RLS policies (run after RLS is enabled)
...
-- Step 6: Insert sample data (optional - for development only)
-- Remove these in production or modify with real user IDs
