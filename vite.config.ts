      ...
      server: {
        headers: {
          ...
          'Content-Security-Policy': [
            ...
            "font-src 'self' data:",
            "connect-src 'self' https://api.github.com https://raw.githubusercontent.com https://peka01.github.io https://generativelanguage.googleapis.com https://*.supabase.co https://api-free.deepl.com https://api.deepl.com",
            "frame-src 'self'",
            "object-src 'none'",
            "base-uri 'self'",
            "form-action 'self'",
